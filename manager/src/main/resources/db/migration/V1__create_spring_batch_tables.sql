...
(
    ...
    JOB_EXECUTION_ID   BIGINT       NOT NULL,
    CREATE_TIME        TIMESTAMP    NOT NULL,
    START_TIME         TIMESTAMP DEFAULT NULL, -- Changed to nullable
    END_TIME           TIMESTAMP DEFAULT NULL,
    STATUS             VARCHAR(10),
    COMMIT_COUNT       BIGINT,
    READ_COUNT         BIGINT,
...
-- Add indexes to improve Spring Batch performance
CREATE INDEX idx_batch_job_instance_job_key ON BATCH_JOB_INSTANCE (JOB_KEY);
CREATE INDEX idx_batch_job_execution_status ON BATCH_JOB_EXECUTION (STATUS);
CREATE INDEX idx_batch_step_execution_job_execution ON BATCH_STEP_EXECUTION (JOB_EXECUTION_ID);
